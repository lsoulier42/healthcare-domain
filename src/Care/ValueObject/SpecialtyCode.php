...
/**
 * Ordinal specialty coded with an externally governed terminology
 * (canonically ANS TRE_R38). Wraps a generic Coding so that
 * historical, deprecated and future codes remain representable.
 */
final readonly class SpecialtyCode
{
